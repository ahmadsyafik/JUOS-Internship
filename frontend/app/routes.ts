...
export default [
  ...
  layout("routes/_layout.tsx", [
    ...
    route("letters/create/psb",         "routes/letters/psb.tsx"),
    route("letters/create/surat-jalan", "routes/letters/surat-jalan.tsx"),
    route("letters/create/pkwt",        "routes/letters/pkwt.tsx"),
